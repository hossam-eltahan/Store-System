        ...
        <div class="card-body">
            <form method="POST" id="returnForm">
                ...
                <div id="selectedInvoice" style="display: none;">
                    ...
                    <button type="submit" class="btn btn-primary btn-lg">💾 حفظ المرتجع وطباعة الإيصال</button>
                </div>
            </form>
        </div>
    </div>
    ...
    container.innerHTML = items.map((item, index) => `
        <div class="return-item-row">
            ...
            <div style="flex: 1;">
                ...
                <small>الوحدة: ${item.unit} | السعر الأصلي: ${item.unit_price} | الكمية في الفاتورة: ${item.quantity}</small>
            </div>
