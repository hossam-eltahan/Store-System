...
requireAnyPermission(['payments.customer', 'payments.view']);

$id = $_GET['id'] ?? 0;
$returnUrl = hasPermission('payments.view') ? 'index.php' : (hasPermission('payments.customer') ? 'pay_customer.php' : '../../index.php');
